\Lecture{Jayalal Sarma}{Sept 19, 2020}{05}{Multichoosing}{Narasimha Sai Vempati}{$\beta$}{JS}
...
\section{The Algebraic Expression for Multichoosing}\label{alg-expr}
...
\section{A few Identities Involving Multichoosing}
...
\Lecture{Jayalal Sarma}{Sept 19, 2020}{06}{Catalan Bijections}{Anshu and Narasimha Sai}{$\beta$}{JS}
